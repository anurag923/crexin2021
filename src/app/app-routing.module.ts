...
const routes: Routes = [
  ...
  { path: 'subcategories', loadChildren: () => import('./components/subcategories/subcategories.module').then(m => m.SubcategoriesModule) },
  ...
  { path: 'singleproduct', loadChildren: () => import('./components/singleproduct/singleproduct.module').then(m => m.SingleproductModule) },
  {
